            ...
            <Navbar bg="light" expand="lg">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    ...
                    {cheks ? <Nav.Link href="/Auth/Manage" className="text-info" onClick={() => this.prevDef}>{displayName !== null ? displayName+"'s" : ""} management</Nav.Link> :
                        <Nav.Link href="/AuthO/Register" className="text-info" onClick={() => this.prevDef}>Register</Nav.Link>}

                    {cheks ? <Nav.Link href="/AuthO/Logout" className="mr-3 text-info" onSubmit={() => this.prevDef}>Log out</Nav.Link> : <Nav.Link href="/AuthO/LogIn" className="mr-3 text-info" onClick={() => this.prevDef}>LogIn</Nav.Link>}
